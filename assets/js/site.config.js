...
window.GALLERIES = {
  ...
  life: {
    ...
    items: [
      ...
      { src: "assets/img/photos/service-teaching.jpg", caption: "Pastor John Deus teaching during a service" },
      { video: "assets/video/congregation-worship.mp4", poster: "assets/video/congregation-worship.jpg", caption: "The congregation in worship" },
      { src: "assets/img/photos/service-choir.jpg", caption: "Ministering with the worship team behind" },
      { src: "assets/img/photos/congregation-hall.jpg",     caption: "Sunday morning in the hall" },
      { src: "assets/img/photos/service-singing.jpg", caption: "Leading the congregation in song" },
      { src: "assets/img/photos/church-building.jpg",       caption: "Our church building" },
      { src: "assets/img/photos/service-hand-raised.jpg", caption: "Hand raised in worship with the choir" },
      { video: "assets/video/kids-ministry.mp4", poster: "assets/video/kids-ministry.jpg", caption: "Sunday School - Happy Kids" },
      { src: "assets/img/photos/service-scripture.jpg", caption: "Preaching from the Scriptures" },
      ...
      { src: "assets/img/photos/service-prayer.jpg", caption: "A moment of prayer" },
      { video: "assets/video/kids-praise.mp4", poster: "assets/video/kids-praise.jpg", caption: "The children in praise" },
      { src: "assets/img/photos/service-worship.jpg", caption: "Leading worship in Kiswahili" },
      { src: "assets/img/photos/heritage-crusade.jpg",      caption: "An open-air crusade in Tanzania" },
      { src: "assets/img/photos/service-smiling.jpg", caption: "Preaching to the congregation" },
      { src: "assets/img/photos/heritage-meeting.jpg",      caption: "A gathering of believers" },
      ...
      { src: "assets/img/photos/service-pulpit.jpg", caption: "Reading at the pulpit" },
      { video: "assets/video/kids-welcome.mp4", poster: "assets/video/kids-welcome.jpg", caption: "Welcoming the children" },
      { src: "assets/img/photos/service-preaching-tent.jpg", caption: "Preaching under the tent" },
      { src: "assets/img/photos/church-sign-town.jpg",      caption: "Finding us in town" },
      { src: "assets/img/photos/service-greeting.jpg", caption: "Greeting the congregation" },
      { src: "assets/img/photos/street-outreach.jpg",       caption: "Out in the city at night" },
      { src: "assets/img/photos/service-pointing.jpg", caption: "Making a point during the message" },
      { src: "assets/img/photos/service-emphasis.jpg", caption: "Teaching the Word" },
      { src: "assets/img/photos/service-seated.jpg", caption: "Pastor John Deus and his wife during a service" }
    ]
  }
};
